 ...
 * 
 * String authHeader = httpRequest.getHeader("authorization"); if(authHeader ==
 * null || !authHeader.startsWith("Bearer")) { throw new
 * ServletException("Missing or invalid Authentication Header"); }
 * 
 * String jwtToken = authHeader.substring(7);
 * 
 * Claims claims =
 * Jwts.parser().setSigningKey("secret key").parseClaimsJws(jwtToken).getBody();
 * 
